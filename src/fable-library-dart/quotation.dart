...
types.Some<types.Tuple3<dynamic, dynamic, dynamic>>? isCall(Expr expr) {
  if (expr is ExprCall) {
    ...
    final normalized =
        (inst is ExprValue && inst.type == 'null') ? null : inst;
...
types.Some<types.Tuple3<dynamic, dynamic, dynamic>>? isNewUnionCase(Expr expr) =>
    expr is ExprNewUnion
        ? types.Some<types.Tuple3<dynamic, dynamic, dynamic>>(
            types.Tuple3<dynamic, dynamic, dynamic>(
                expr.typeName, expr.unionTag, list.ofArray<dynamic>(expr.fields)))
        : null;
...
types.Some<types.Tuple2<dynamic, dynamic>>? isFieldGet(Expr expr) =>
    expr is ExprFieldGet
        ? types.Some<types.Tuple2<dynamic, dynamic>>(
            types.Tuple2<dynamic, dynamic>(expr.expr, expr.fieldName))
        : null;
